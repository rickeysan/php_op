...
class Patient extends Human{
    ...
    protected $need_treatment;
    protected $recovery_flg;
    protected $dead_flg;
    public function __construct($hp,$need_treatment,$img){
        $this->hp = $hp;
        $this->need_treatment = $need_treatment;
        $this->recovery_flg = false;
        $this->dead_flg = false;
        $this->img = $img;
    }

    function setNeedTreatment($num){
        $this->need_treatment = $num;
    }
    function getNeedTreatment(){
        return $this->need_treatment;
    }
...
// 患者のインスタンス作成
$mild = new Patient(mt_rand(5,10),Severity::light,mt_rand(5,10),'img/sick_hatunetsu_man.png');
